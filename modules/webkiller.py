...
def webkiller():
    try:
        ...
        if com[0:13] == 'set interface':
            ...
            subprocess.Popen('echo 1 > /proc/sys/net/ipv4/ip_forward', stdout=subprocess.PIPE,
            ...
            print(wcolors.color.BOLD + wcolors.color.BLUE + "[*]Attack Has Been Stopped." + wcolors.color.ENDC)
        else:
